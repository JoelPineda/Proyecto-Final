...
export const EditBackendUsers = (e) => {
  ...
  let dropcompany = [
    '<select class="form-control container chosen-select  validate-option" data-placeholder="--Seleccione--" id="dropCompany" value="' +
      dataItem.companyId +
      '"   >',
  ];
  ...
  let tableData =
    ...
    "<input type='text' class='form-control validate-text' id='tbAliasName' title='Alias' value='" +
    dataItem.Alias +
    "' readonly  />" +
    "</div>" +
    "<div class='form-group  col-md-6'>" +
    "<div class='divLeft'><label for='tbUserName'>Usuario:<span class='red title-required fa faa-flash animated'></span></label></div>" +
    "<input type='text' class='form-control validate-text' id='tbUserName' title='Usuario' data-id='" +
    dataItem.UserId +
    "' value='" +
    dataItem.User +
    "' readonly   />" +
    ...
    "<input type='text' class='form-control validate-text' id='tbPsw' title='Contraseña'  value='" +
    dataItem.Psw +
    "'   />" +
    "</div>" +
    "<div class='form-group'>" +
    "<div class='divLeft'><label for='dropPermission'>Permisos:</label><span class='title-required fa faa-flash animated'></span></div>" +
