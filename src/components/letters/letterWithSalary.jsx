...
export const GetLetterWithSalary = ({ props})=>{
    const {rnc, sello, companyName, address,phones, email,  companyLogo,header_date, employee_id_card,employee_name, hiring_date, date, prefix, position_name, responsable_name, responsable_position, urlImageSigned, salary_frequency, salary} = props;
