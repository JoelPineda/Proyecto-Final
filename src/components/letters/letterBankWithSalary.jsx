...
export const GetLetterBankWithSalary = ({ props})=>{
    const {rnc,sello, companyName, address,phones, email, companyLogo, header_date, employee_id_card,employee_name, hiring_date, date, prefix, position_name, responsable_name, responsable_position, urlImageSigned, salary_frequency, salary, bankName} = props;
        ...
        `<html><body><section>
            <div class="container">
                ...
                <p style="margin-bottom: 0.25in; line-height: 100%; text-align: left;"><font face="Times New Roman, serif"><font size="3">Señores:<br /><br /></font></font><font face="Times New Roman, serif"><font size="3">
                    <strong style="font-weight: bold; text-transform: capitalize;">${bankName}</strong></font></font><font face="Times New Roman, serif"><font size="3"><br /><br />Ciudad</font></font></p>
