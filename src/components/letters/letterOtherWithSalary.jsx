...
export const GetLetterOtherWithSalary = ({ props }) => {
  const {
    rnc,
    sello,
    companyName,
  ...
  return `<html><body><section>
            <div class="container">
                ...
                <p style="margin-bottom: 0.25in; line-height: 100%; text-align: left;"><font face="Times New Roman, serif"><font size="3">Señores:<br /><br /></font></font><font face="Times New Roman, serif"><font size="3">
                    <strong style="font-weight: bold; text-transform: capitalize;">${OtherEntityName}</strong></font></font><font face="Times New Roman, serif"><font size="3"><br /><br />Ciudad</font></font></p>
